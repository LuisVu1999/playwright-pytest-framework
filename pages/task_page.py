...
class TaskPage (BasePage):
    ...
    def view_task(self, task_name_tag: str, priority_tag: str, project_tag: str, client_tag: str, 
        ...
        self.assert_text_contain(TaskLocator.TASK_NAME_TAG, task_name_tag)
        self.assert_text(TaskLocator.PRIORITY_TAG, priority_tag)
        ...
        self.assert_text(TaskLocator.VIEW_TASK_NAME, view_task_name)
