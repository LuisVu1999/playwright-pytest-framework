...
class TemplatePage(BasePage):
    ...
    def view_template(self, details_tab: str, task_tab: str, milestones_tab: str, testing: str, 
        ...
        self.assert_text(TemplateLocator.DETAILS_TAB, details_tab)
        self.assert_text(TemplateLocator.TASK_TAB, task_tab)
        self.assert_text(TemplateLocator.MILESTONES_TAB, milestones_tab)
        ...
        self.assert_text(TemplateLocator.TESTING, testing)
        self.assert_text(TemplateLocator.DEVELOPMENT, development)
        self.assert_text(TemplateLocator.PLANNING, planning)
        self.assert_text(TemplateLocator.DESIGN, design)
        self.assert_text(TemplateLocator.UNCATEGORIED, uncategoried)
        self.assert_visible(TemplateLocator.DELETE)
        self.assert_visible(TemplateLocator.EDIT_IN_MILESTONE_BUTTON)
        self.assert_text(TemplateLocator.FILE_TAB, file_tab)
